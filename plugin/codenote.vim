...
nnoremap <silent> <leader>nl :call codenote#YankPathLine(0, 1)<CR>
...
nnoremap <silent> <leader>] <cmd>call codenote#GoToCodeNoteLink(v:false)<CR>
nnoremap <silent> <leader>np <cmd>call codenote#PreviewNoteSnippet()<CR>
