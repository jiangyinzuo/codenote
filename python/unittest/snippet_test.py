...
def test_headline():
    table = [
        (
            "/abc/文件-sss_.cpp:12",
            ("/abc/文件-sss_.cpp", "12", None, None, None, None, None),
            Snippet.HeadLine("/abc/文件-sss_.cpp", 12),
            "/abc/文件-sss_.cpp:12",
        ),
        (
            "/abc/def-sss_.cpp:12",
            ("/abc/def-sss_.cpp", "12", None, None, None, None, None),
            Snippet.HeadLine("/abc/def-sss_.cpp", 12),
            "/abc/def-sss_.cpp:12",
        ),
        (
            "/abc/def.cpp:12",
            ("/abc/def.cpp", "12", None, None, None, None, None),
        ...
        (
            ...
            ("/abc/def", "12", None, None, None, None, " v0.1.1 33"),
            None,
            "None",
        ),
        (
            "/abc/def:12 v0.1.1 snippet_id=33",
            ("/abc/def", "12", None, None, None, None, " v0.1.1 snippet_id=33"),
            None,
            "None",
        ),
        (
            "/abc/def:12-23 v0.1.1  snippet_id=3",
            ("/abc/def", "12", "-23", None, None, None, " v0.1.1  snippet_id=3"),
            None,
            "None",
        ),
        (
            "/abc/def:12-23 version=v0.1.1 ",
            ("/abc/def", "12", "-23", None, " version=v0.1.1", None, None),
        ...
        (
            ...
            Snippet.HeadLine(
                "/abc/def", 12, line_num_end=23, submodule="llvm", git_version="18.0"
            ),
            "/abc/def:12-23 submodule=llvm version=18.0",
        ),
        (
            "/abc/def:12-23 submodule=llvm ",
            ("/abc/def", "12", "-23", " submodule=llvm", None, None, None),
            Snippet.HeadLine("/abc/def", 12, line_num_end=23, submodule="llvm"),
            "/abc/def:12-23 submodule=llvm",
        ),
        (
            "/abc/def:12-23   33    ",
            ("/abc/def", "12", "-23", None, None, None, "   33"),
            None,
            "None",
        ),
        (
            "/abc/def:12 version=v0.1.1 nippet_id=33",
            ("/abc/def", "12", None, None, " version=v0.1.1", None, " nippet_id=33"),
            None,
            "None",
        ),
        (
            "/abc/def.h:12 version=v0.1.1 snippet_id=33",
            ("/abc/def.h", "12", None, None, " version=v0.1.1", " snippet_id=33", None),
            Snippet.HeadLine(
                "/abc/def.h", 12, line_num_end=None, git_version="v0.1.1", snippet_id=33
            ),
            "/abc/def.h:12 version=v0.1.1 snippet_id=33",
        ),
        (
